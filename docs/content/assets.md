...
Stage backgrounds use a typed runtime catalog instead of a sprite-manifest entry:

- runtime asset catalog: `src/content/stageBackgroundCatalog.ts`
- stage-to-background mapping: `src/content/campaign.ts`
- source and attribution log: `assets/backgrounds/README.md`

Backgrounds are loaded as plain images and composed in-scene as layered parallax backdrops. Keep each imported pack documented with source URL, author, and license.
