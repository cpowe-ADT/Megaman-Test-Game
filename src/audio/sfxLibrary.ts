 ...
 * through `BossBeats.playAttackSfx`); an attack plays the mechanic or saber sound that fits it (part 12h) and the rest stay silent.
...
export const SFX_ALIASES: Readonly<Record<string, SfxAssetKey | null>> = {
  'Giga Hop': null,
  'Guard Shot': null,
  'Stomp Shock': 'miniboss_shockwave',
  'Serpent Stream': 'vent_fire',
  'Ignition Dash': 'vent_fire',
  'Blaze Lob': null,
  'Jet Levitate': null,
  'Lance Volley': null,
  'Riptide Crash': null,
  'Capacitor Charge': 'charge_start',
  'Rail Shot': 'rail_arc',
  'Impulse Dash': null,
  'Fault Punch': 'wall_crack',
  'Basalt Barrage': 'rockfall',
  Crustquake: 'crumble_shake',
  'Vector Slice': 'sword_swing',
  'Mag Disc': null,
  'Polar Snare': null,
  'Toxic Slide': null,
  'Glob Lob': null,
  'Toxic Bloom': null,
  'Turbine Slice': 'wind_gust',
  'Aero Volley': null,
  'Cyclone Lift': 'wind_gust',
  'Glacier Slide': null,
  'Frost Draw': 'sword_swing',
  'Shard Rain': 'icicle_shatter',
  'Directive Volley': null,
  'Lockdown Pulse': 'gate_close',
  'Core Ram': null,
  'Override Cascade': null,
  // Desperation attacks (`blueprint.desperation.attack`, outside `attacks`).
  'Rook Barrage': null,
  'Magma Geyser': 'slag_rise',
  Maelstrom: null,
  'Storm Grid': 'rail_arc',
  'Tectonic Rift': 'wall_break',
  'Disc Storm': null,
  'Miasma Flood': null,
  Tempest: 'wind_gust',
  'Absolute Zero': 'icicle_shatter',
